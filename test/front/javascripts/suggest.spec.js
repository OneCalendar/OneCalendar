...
(function() {
  ...
  describe('google suggest like', function() {
    ...
    it("7. should add devoxx url in link for devoxx section", function() {
      ...
      return expect($("#devoxx a.webcal").attr("href")).toContain('/events/AGILEFRANCE');
    });
    ...
    return it("14. shoud format icalendar date format", function() {
      return expect(SUGGEST.formatIcalDate("2012-04-19T14:30:00.000+02:00")).toEqual("19 04 2012 - 14:30");
    });
  });
