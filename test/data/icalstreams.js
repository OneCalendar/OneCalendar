...
if (db.getName() === "OneCalendar") {
    ...
    save({ "url" : "http://www.meetup.com/AGILE-NET-FRANCE/events/ical/AGILE+.NET+FRANCE/ical.ics", "streamTags" : ["Agile","Software","Méthode","Agile","Agile","Methods","Microsoft",".NET","Technologies","Agile","Software","Development","Windows","Azure","Platform","Open","ALM","Application","Lifecycle","Management","Microsoft","Technology","Agile","Coaching","Product","management","agile","SQL","Server","Azure","Microsoft",".Net","User","Group","Agile","Games"] });
    save({ "url" : "http://www.meetup.com/Agile-Play-Ground/events/ical/Agile+Play+Ground/", "streamTags" : ["Agile","Software","Software","Development","Agile","Software","Development","Lean","Software","Development","Scrum","Master","Scrum","Development","Agilité","jeux"] });
    ...
    save({ "url" : "http://www.meetup.com/lean-startup-france/events/ical/Lean+Startup+France/", "streamTags" : ["Agile","Project","Management","Agile","Software","Business","Strategy","Networking","Entrepreneur","Startup","Ventures","Entrepreneurship","Lean","Software","Development","Lean","Startup","Customer","Development"] });
    ...
    save({ "url" : "http://www.meetup.com/OpenStack-France/events/ical/OpenStack+France/", "streamTags" : ["Cloud","Computing","Web","Development","Open","Source","Cloud","Storage","OpenStack","Building","private","cloud","OpenStack","OpenStack","Quantum","Cloud","Networking"] });
    save({ "url" : "http://www.meetup.com/Paris-Cloud-Computing-Group/events/ical/Paris+Cloud+Computing+Group/", "streamTags" : ["High","Scalability","Computing","SaaS","Cloud","Computing","Virtualization","Cloud","Computing","SaaS","Software","Service","Amazon","Web","Services","Web","Technology","Cloud","Computing","IAAS","Cloud","Computing","IaaS","Infrastructure","Service","Open","Source","OpenStack","PaaS","Cloud","Computing","PaaS","Platform","Service","Cloud","System","Adminstrators"] });
    save({ "url" : "http://www.meetup.com/Paris-Salesforce-Developer-User-Group/events/ical/Paris+Salesforce+Developer+User+Group/", "streamTags" : ["Software","Developers","Cloud","Computing","Programming","Mobile","Development","Heroku","PaaS","Cloud","Computing","mobile","application","development","Salesforce.com","Developers","Force.com","Apex","Development","Apex"] });
    ...
    //ruby
    save({ "url" : "http://meetup.rubyparis.org/events/ical/Paris.rb/", "streamTags" : ["Programming","Agile","Software","Ruby","Rails","Ruby","Open","Source","Freelances","Paris","Freelance"] });

    save({ "url" : "http://meetup.paug.fr/events/ical/Paris+Android+User+Group/", "streamTags" : ["Android","Development","mobile","applications","Android","App","Marketing","Android","Enthusiasts","Android","Fans","Users","Google","Android","Application","Development","Mobile","Social","Mobile","Development","Mobile","Technology","Android","developers","Software","Developers","Java","Google","Technology","User","Group","android"] });
    save({ "url" : "http://www.meetup.com/Paris-Android-LiveCode/events/ical/Paris+Android+LiveCode/", "streamTags" : ["Mobile","Technology","android","Android","Development","Android","Enthusiasts","Java","Android","developers","Android","Application","Development","Android","SDK","Android","Fans","Users","mobile","applications","Eclipse","IDE"] });
    ...
    save({ "url" : "http://www.meetup.com/paris-titanium/events/ical/Paris+Titanium/", "streamTags" : ["Développer","iPhone","Titanium","Développer","Android","Titanium","Développer","Blackberry","Titanium","Utiliser","web","mobiles","Développement","applications","mobiles","Appcelerator","Titanium","JavaScript","Développeurs","iPhone","Développeurs","Android","Développement","iPad"] });
    ...
    save({ "url" : "http://www.meetup.com/windowsapps/events/ical/Windows+Apps/", "streamTags" : ["Mobile","Technology","Silverlight","mobile","applications","C#","Windows","Phone","XAML","HTML5","Windows",".NET","Windows","Mobile","Windows8","Development","Windows8","Metro","App","Development","Windows","Phone","Developers","Windows","Phone7","Mobile","Development"] });
    save({ "url" : "http://www.meetup.com/Cassandra-Paris-Meetup/events/ical/Cassandra+Paris+Meetup/", "streamTags" : ["Data","Analytics","Mobile","Development","Web","Development","Mobile","Technology","Cassandra","Big","Data","NoSQL","hadoop","Cloud","Computing","Java","Open","Source","High","Scalability","Computing","Programming","Software","Developers","Apache","Lucene","Solr","Open","Source","Search"] });
    save({ "url" : "http://meetupparis.hackshackers.com/events/ical/Hacks-Hackers+Paris/", "streamTags" : ["HacksandHackers"] });
    save({ "url" : "http://www.meetup.com/78-Hackers/events/ical/78+Hackers/", "streamTags" : ["PHP","Open","Source","Python","JavaScript","Web","Technology","JQuery","Programming","Programming","Languages","Functional","Programming","Machine","Learning","NLP/Neurolinguistic","Programming","Science","Scientific","Research","Technology","HTML5","Artificial","Intelligence","Applications","mongoDB"] });

    save({ "url" : "http://www.meetup.com/ParisHackers/events/ical/ParisHackers/", "streamTags" : ["Social","Networking","Professional","Networking","Self-Improvement","Business","Strategy","Networking","Meeting","New","People","Small","Business","New","Technology","Internet","Technology","Programming","Web","Technology","Software","Developers","Entrepreneur","Android","developers","Mobile","Technology","Mobile","Development"] });
    ...
    save({ "url" : "http://www.meetup.com/BeMyAppfrance/events/ical/BeMyApp+WeekEnds+France/", "streamTags" : ["mobile","applications","Programming","iPhone","Development","iPhone","App","Developers","Internet","Technology","hackathon","Web","Design","Web","Designers","Developers","Android","developers","iPhone","developers","Windows","Mobile","HTML5","Startup","Enterprenurs","iOS","Development"] });
    save({ "url" : "http://www.meetup.com/web-new-media-paris/events/ical/The+Web+%26+New+Media+Professionals/", "streamTags" : ["Interaction","Design","Internet","Professionals","EBusiness","Owners","Marketing","Entrepreneur","Web","Design","Social","Media","Marketing","Web","Startups","Writers,Artists","Musicians","Internet","Marketing","Graphical","User","Interfaces","Web","Communications","Web","Technology","Blogger","Business","Strategy","Networking"] });
    ...
    save({ "url" : "http://www.meetup.com/France-HTML5-User-Group/events/ical/France+HTML5+User+Group/", "streamTags" : ["Internet","tecnología","Mobile","Development","Web","Standards","Mobile","Technology","Internet","Marketing","New","Technology","Open","Source","Web","Design","HTML5","CSS","JavaScript","Web","Technology","css3","HTML","Web","Development"] });
    ...
    save({ "url" : "http://www.meetup.com/Wordpress-Developers-Paris/events/ical/Paris+Wordpress+Developer+Meetup/", "streamTags" : ["Web","Design","Search","Engine","Optimization","WordPress","Users","Wordpress","Customization","Wordpress","Help","PHP","WordPress","Small","Business","Web","Sites","WordPress","Web","Content","Management","Systems","WordPress","as","Content","Management","System","CMS","Blog"] });
    save({ "url" : "http://www.meetup.com/Paris-Arduino/events/ical/Paris+Arduino/", "streamTags" : ["Makerspaces","Hacking","Microcontrollers","hackerspaces","Artificial","Intelligence","electronics","DoItYourself","Robotics","Arduin","Arduino","Arduino","Robotics","Arduino","Netduino","Robotics","Arduino","Uno","Programming"] });
